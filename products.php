...
if ($typeItemsN === '') {
    ...
    $sql = "SELECT * FROM `shopitems` WHERE Type='$typeItemsN' ORDER BY Id ASC";
}
                                    ...
                                    while ($product = mysqli_fetch_array($result)) {
                                        ...
                                        <div class="divProduct">
                                            ...
                                            <div class="divProductDetail">
                                                ...
                                                <span class="spanProductPriceLabel">PRICE:<span class="spanProductPrice"><?php echo number_format(floatval($product['Price']), 0, ".", ","); ?> $</span> </p>
                                            </div>
                                        </div>
                                        <?php
                                    }
